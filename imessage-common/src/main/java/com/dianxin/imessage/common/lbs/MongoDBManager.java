...
public enum MongoDBManager {
    ...
    private static final  String MONGODB_HOST = "123.57.66.200";
    private static final  int    MONGODB_PORT = 27017;

    // 数据库名
    public static String DB_NAME = "lbs";
    //集合名
    public static String COLL_POSITION = "position";
    //集合名
    public static String COLL_TRAIL = "trail";
    //集合名
    public static String COLL_CHAT = "chat";

    static {
        System.out.println("===============MongoDBUtil初始化========================");
        // 从配置文件中获取属性值
        String ip = MONGODB_HOST;
    ...
    {
        String dbName = "lbs";
        String collName = "position";
        MongoCollection<Document> coll = MongoDBManager.instance.getCollection(dbName, collName);
        for(int i = 0 ;i< 7;i++)
        {
            List<Double> gps = new ArrayList<Double>();
            gps.add(Double.valueOf("106.42229"+i));
            gps.add(Double.valueOf("36.051453"+i));
            // 插入多条
    ...
    public static void main(String[] args) {
        ...
        LbsLogic.getLbs("106.359975", "35.846417");
...
//        Document doc1 = MongoDBManager.instance.findById(coll, id);
...
//        MongoDBManager.instance.find(coll, filter);
